    ...
    <div className="mx-auto max-w-6xl px-4 py-16">
      ...
      <div className="mt-10 grid gap-6 sm:grid-cols-3">
        {taxiServices.map((service) => (
          <div key={service.id} className="rounded-lg border border-slate-200 p-6">
      ...
      <div className="mt-10">
        <Link
          href="/booking"
          className="inline-block rounded-md bg-brand px-6 py-3 text-sm font-semibold text-black hover:bg-brand-dark"
        >
          Request a taxi
        </Link>
      </div>
